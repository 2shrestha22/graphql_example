...
abstract class $CountryCopyWith<$Res> {
  ...
  $Res call(
      {String name, String code, String phone, String? capital, String emoji});
}
...
class _$_Country implements _Country {
  ...
  @override
  String toString() {
    return 'Country(name: $name, code: $code, phone: $phone, capital: $capital, emoji: $emoji)';
  }
...
abstract class _Country implements Country {
  const factory _Country(
      ...
      required String phone,
      required String? capital,
      required String emoji}) = _$_Country;
